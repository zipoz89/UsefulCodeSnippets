	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag143_g1 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag143_g1;
						...
						)
			{
				...
				float4 temp_output_13_0_g1 = ( ( _RoomsXYZPropsW + float4( -1E-05,-1E-05,-1E-05,-1E-05 ) ) * _RoomTile );
				float3 vertexToFrag143_g1 = packedInput.ase_texcoord5.xyz;
				#ifdef _SWITCHPLANE_ON
				float staticSwitch147_g1 = (vertexToFrag143_g1).z;
				#else
				float staticSwitch147_g1 = (vertexToFrag143_g1).x;
				#endif
				float4 appendResult146_g1 = (float4(vertexToFrag143_g1 , staticSwitch147_g1));
				float4 InterpVertexPos148_g1 = appendResult146_g1;
				float4 temp_output_10_0_g1 = ( InterpVertexPos148_g1 - _PositionOffsetXYZroomsWprops );
				float3 worldToObj161_g1 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(_WorldSpaceCameraPos), 1 ) ).xyz;
				#ifdef _SWITCHPLANE_ON
				float staticSwitch157_g1 = (worldToObj161_g1).z;
				#else
				float staticSwitch157_g1 = (worldToObj161_g1).x;
				#endif
				float4 appendResult158_g1 = (float4((worldToObj161_g1).xyz , staticSwitch157_g1));
				float4 TransCameraPos159_g1 = appendResult158_g1;
				float4 V211_g1 = ( TransCameraPos159_g1 - _PositionOffsetXYZroomsWprops );
				float4 V116_g1 = ( temp_output_10_0_g1 - V211_g1 );
				float4 temp_output_24_0_g1 = ( ( ( ( floor( ( temp_output_13_0_g1 * temp_output_10_0_g1 ) ) + step( float4( 0,0,0,0 ) , V116_g1 ) ) / temp_output_13_0_g1 ) - V211_g1 ) / V116_g1 );
				float Y36_g1 = (temp_output_24_0_g1).y;
				float newPlane27_g1 = (temp_output_24_0_g1).w;
				float Z30_g1 = (temp_output_24_0_g1).z;
				float4 temp_output_102_0_g1 = ( ( newPlane27_g1 * V116_g1 ) + V211_g1 );
				#ifdef _SWITCHPLANE_ON
				float2 staticSwitch103_g1 = (temp_output_102_0_g1).xy;
				#else
				float2 staticSwitch103_g1 = (temp_output_102_0_g1).yz;
				#endif
				float2 break98_g1 = ( staticSwitch103_g1 * _PropsTexTiling );
				float2 appendResult96_g1 = (float2(break98_g1.y , break98_g1.x));
				float2 appendResult97_g1 = (float2(break98_g1.x , break98_g1.y));
				#ifdef _SWITCHPLANE_ON
				float2 staticSwitch95_g1 = appendResult97_g1;
				#else
				float2 staticSwitch95_g1 = appendResult96_g1;
				#endif
				float4 tex2DNode89_g1 = tex2Dbias( _Props, float4( staticSwitch95_g1, 0, -1.0) );
				float4 break90_g1 = tex2DNode89_g1;
				float4 appendResult92_g1 = (float4(break90_g1.r , break90_g1.g , break90_g1.b , 0.0));
				#ifdef _TOGGLEPROPLAYER_ON
				float4 staticSwitch93_g1 = tex2DNode89_g1;
				#else
				float4 staticSwitch93_g1 = appendResult92_g1;
				#endif
				float4 PropsVar94_g1 = staticSwitch93_g1;
				float temp_output_123_0_g1 = step( newPlane27_g1 , ( Z30_g1 * (PropsVar94_g1).w ) );
				float ifLocalVar114_g1 = 0;
				if( temp_output_123_0_g1 > 0.0 )
				ifLocalVar114_g1 = newPlane27_g1;
				else if( temp_output_123_0_g1 == 0.0 )
				ifLocalVar114_g1 = Z30_g1;
				else if( temp_output_123_0_g1 < 0.0 )
				ifLocalVar114_g1 = Z30_g1;
				float X35_g1 = (temp_output_24_0_g1).x;
				float temp_output_113_0_g1 = step( ifLocalVar114_g1 , X35_g1 );
				float ifLocalVar116_g1 = 0;
				if( temp_output_113_0_g1 <= 0.0 )
				ifLocalVar116_g1 = X35_g1;
				else
				ifLocalVar116_g1 = ifLocalVar114_g1;
				float2 break78_g1 = ( (( ( Z30_g1 * V116_g1 ) + V211_g1 )).xy * _WalltexTiling );
				float2 appendResult77_g1 = (float2(break78_g1.x , break78_g1.y));
				float4 WallVar87_g1 = tex2D( _Wall, appendResult77_g1 );
				float4 ifLocalVar120_g1 = 0;
				if( temp_output_123_0_g1 <= 0.0 )
				ifLocalVar120_g1 = WallVar87_g1;
				else
				ifLocalVar120_g1 = PropsVar94_g1;
				float4 BackVar68_g1 = tex2D( _Back, ( (( ( X35_g1 * V116_g1 ) + V211_g1 )).zy * _BackWallTexTiling ) );
				float4 ifLocalVar119_g1 = 0;
				if( temp_output_113_0_g1 <= 0.0 )
				ifLocalVar119_g1 = BackVar68_g1;
				else
				ifLocalVar119_g1 = ifLocalVar120_g1;
				float2 temp_output_56_0_g1 = (( ( Y36_g1 * V116_g1 ) + V211_g1 )).xz;
				float Y_inverted39_g1 = (V116_g1).y;
				float4 lerpResult63_g1 = lerp( tex2D( _Floor, ( temp_output_56_0_g1 * _FloorTexTiling ) ) , tex2D( _Ceiling, ( temp_output_56_0_g1 * _CeilingTexTiling ) ) , step( 0.0 , Y_inverted39_g1 ));
				float4 CeilVar66_g1 = lerpResult63_g1;
				float4 ifLocalVar110_g1 = 0;
				if( Y36_g1 <= ifLocalVar116_g1 )
				ifLocalVar110_g1 = CeilVar66_g1;
				else
				ifLocalVar110_g1 = ifLocalVar119_g1;
				float4 temp_output_43_0_g1 = ( _RoomColorTint * ( ifLocalVar110_g1 * _RoomIntensity ) );
				float2 uv_FacadeAlbedo = packedInput.ase_texcoord6.xy * _FacadeAlbedo_ST.xy + _FacadeAlbedo_ST.zw;
				float2 uv1138_g1 = ( uv_FacadeAlbedo * _FacadeTiling );
				float4 tex2DNode48_g1 = tex2D( _FacadeAlbedo, uv1138_g1 );
				float4 lerpResult42_g1 = lerp( temp_output_43_0_g1 , tex2DNode48_g1 , tex2DNode48_g1.a);
				#ifdef _FACADETEXTURE_ON
				float4 staticSwitch41_g1 = lerpResult42_g1;
				#else
				float4 staticSwitch41_g1 = temp_output_43_0_g1;
				#endif
				
				#ifdef _FACADETEXTURE_ON
				float staticSwitch136_g1 = ( tex2D( _FacadeSmoothness, uv1138_g1 ).r * _SmoothnessValue );
				#else
				float staticSwitch136_g1 = 0.0;
				#endif
				
				surfaceDescription.BaseColor = staticSwitch41_g1.rgb;
				...
				surfaceDescription.Smoothness = staticSwitch136_g1;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag143_g1 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag143_g1;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 temp_output_13_0_g1 = ( ( _RoomsXYZPropsW + float4( -1E-05,-1E-05,-1E-05,-1E-05 ) ) * _RoomTile );
				float3 vertexToFrag143_g1 = packedInput.ase_texcoord2.xyz;
				#ifdef _SWITCHPLANE_ON
				float staticSwitch147_g1 = (vertexToFrag143_g1).z;
				#else
				float staticSwitch147_g1 = (vertexToFrag143_g1).x;
				...
				ifLocalVar110_g1 = ifLocalVar119_g1;
				float4 temp_output_43_0_g1 = ( _RoomColorTint * ( ifLocalVar110_g1 * _RoomIntensity ) );
				float2 uv_FacadeAlbedo = packedInput.ase_texcoord3.xy * _FacadeAlbedo_ST.xy + _FacadeAlbedo_ST.zw;
				float2 uv1138_g1 = ( uv_FacadeAlbedo * _FacadeTiling );
				float4 tex2DNode48_g1 = tex2D( _FacadeAlbedo, uv1138_g1 );
				float4 lerpResult42_g1 = lerp( temp_output_43_0_g1 , tex2DNode48_g1 , tex2DNode48_g1.a);
				#ifdef _FACADETEXTURE_ON
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				_TimeParameters.xyz = timeParameters;
				float3 vertexToFrag143_g1 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag143_g1;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float4 temp_output_13_0_g1 = ( ( _RoomsXYZPropsW + float4( -1E-05,-1E-05,-1E-05,-1E-05 ) ) * _RoomTile );
				float3 vertexToFrag143_g1 = packedInput.ase_texcoord7.xyz;
				#ifdef _SWITCHPLANE_ON
				float staticSwitch147_g1 = (vertexToFrag143_g1).z;
				#else
				float staticSwitch147_g1 = (vertexToFrag143_g1).x;
				...
				ifLocalVar110_g1 = ifLocalVar119_g1;
				float4 temp_output_43_0_g1 = ( _RoomColorTint * ( ifLocalVar110_g1 * _RoomIntensity ) );
				float2 uv_FacadeAlbedo = packedInput.ase_texcoord8.xy * _FacadeAlbedo_ST.xy + _FacadeAlbedo_ST.zw;
				float2 uv1138_g1 = ( uv_FacadeAlbedo * _FacadeTiling );
				float4 tex2DNode48_g1 = tex2D( _FacadeAlbedo, uv1138_g1 );
				float4 lerpResult42_g1 = lerp( temp_output_43_0_g1 , tex2DNode48_g1 , tex2DNode48_g1.a);
				#ifdef _FACADETEXTURE_ON
